...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("quickCheck: "+ Duplicate.quickCheck(arr));
        System.out.println("midCheck: "+ Duplicate.midCheck(arr));
        System.out.println("kCheck: "+ Duplicate.kCheck(arr));
    }
